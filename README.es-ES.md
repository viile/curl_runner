...
lang: es
permalink: /es/
title: "cURL Runner — Ejecuta, formatea y visualiza comandos curl localmente"
description: >-
  Herramienta de escritorio curl respetuosa con la privacidad para macOS,
  Windows y Linux. Ejecución local, sin CORS, sin telemetría, sin servidor.
  Vistas JSON árbol / mapa mental, 20 idiomas de interfaz.
---
...
¿Prefieres el navegador? Prueba la versión web: <https://viile.github.io/curl_runner/app/>
